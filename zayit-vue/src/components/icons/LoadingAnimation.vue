...
import BookIconWithText from './BookIconWithText.vue';
...
.loading-container {
  ...
  /* Fill parent width */
  font-weight: 600;
  /* Bold text for loading message */
}

/* Book icon with pulse animation */
.icon-pulse :deep(.book-icon) {
...
.dot:nth-child(2) {
  ...
  /* Start animation 0.2s later */
}

/* Third dot - more delayed animation for wave effect */
.dot:nth-child(3) {
  animation-delay: 0.4s;
  /* Start animation 0.4s later */
}
...
@keyframes bounce {
  ...
  100% {
    transform: scale(0);
    /* Invisible/tiny at start, near end, and end */
    opacity: 0.5;
    /* Semi-transparent */
  }
